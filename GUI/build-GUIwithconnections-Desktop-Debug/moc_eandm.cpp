...
#include "../GUIwithconnections/WidgetsUsed/EandM/eandm.h"
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_EandM_t, stringdata) + ofs \
...
QT_MOC_LITERAL(3, 20, 12)
    ...
    "EandM\0NewException\0\0NewSystemMsg\0"
};
...
const QMetaObject EandM::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_EandM.data,
      qt_meta_data_EandM,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_EandM.stringdata))
