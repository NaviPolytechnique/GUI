...
#include "../GUIwithconnections/WidgetsUsed/InputCommands/inputcommands.h"
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_InputCommands_t, stringdata) + ofs \
...
const QMetaObject InputCommands::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_InputCommands.data,
      qt_meta_data_InputCommands,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_InputCommands.stringdata))
