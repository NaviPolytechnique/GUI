...
#include "../GUIwithconnections/WidgetsUsed/Compass/compass.h"
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_Compass_t, stringdata) + ofs \
...
QT_MOC_LITERAL(3, 20, 14)
    ...
    "Compass\0MAJCompass\0\0DroneStatusMAJ\0"
};
...
const QMetaObject Compass::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_Compass.data,
      qt_meta_data_Compass,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_Compass.stringdata))
