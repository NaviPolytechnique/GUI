...
#include "../GUIwithconnections/WidgetsUsed/AttitudeMeter/attitudemeter.h"
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_AttitudeMeter_t, stringdata) + ofs \
...
QT_MOC_LITERAL(3, 32, 14)
    ...
    "AttitudeMeter\0MAJAttitudeMeter\0\0"
    "DroneStatusMAJ\0"
};
...
void AttitudeMeter::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        switch (_id) {
        case 0: _t->MAJAttitudeMeter((*reinterpret_cast< QString(*)>(_a[1]))); break;
        default: ;
        }
    }
}
...
const QMetaObject AttitudeMeter::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_AttitudeMeter.data,
      qt_meta_data_AttitudeMeter,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_AttitudeMeter.stringdata))
