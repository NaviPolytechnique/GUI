...
#include "../GUIwithconnections/threadreadinput.h"
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_ReadInput_t, stringdata) + ofs \
...
const QMetaObject ReadInput::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_ReadInput.data,
      qt_meta_data_ReadInput,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_ReadInput.stringdata))
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    offsetof(qt_meta_stringdata_ThreadReadInput_t, stringdata) + ofs \
        - idx * sizeof(QByteArrayData) \
    )
...
const QMetaObject ThreadReadInput::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_ThreadReadInput.data,
      qt_meta_data_ThreadReadInput,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_ThreadReadInput.stringdata))
